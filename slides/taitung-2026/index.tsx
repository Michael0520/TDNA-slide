...
export const notes: (string | undefined)[] = [
  // H1
  `【中文】\n下午好，我是 Michael，今天下午這三個小時都會跟大家一起。\n先謝謝大家來到台東知本 —— TDF 是台灣最特別的數位遊牧節，這裡的精神就是「把作品 ship 出去」。\nship 這個字今天會一直出現，意思就是「把東西真的做出來、放到網路上、讓別人連得到」。\n三小時後你帶走的，不會只是一個成品，而是一整套「用 AI 把東西做出來」的工作方式。\n我們分三段走：第一小時把工具裝好、把觀念講清楚；第二小時學怎麼用 Claude Code；第三小時你親手做一個網站、推上線。\n放輕鬆，今天完全不需要你會寫程式。\n\n———\n\n【English】\nGood afternoon, I'm Michael, and I'll be with you for these three hours.\nThank you all for coming to Zhiben, Taitung. TDF is Taiwan's most special digital-nomad festival, and the whole spirit here is to "ship."\nThat word will come up a lot today — it just means: actually build something, put it online, let people reach it.\nIn three hours, you won't just leave with a finished product — you'll leave with a whole way of building things with AI.\nWe'll do it in three parts: hour one, install the tools and learn the concepts; hour two, learn to use Claude Code; hour three, you build a real website and ship it.\nRelax — you don't need to know how to code today.`,
  `【中文】\n簡單介紹我自己：我是 Web Developer，平常就在寫網頁；同時也是 Code for Taiwan 的成員，做開源社群的東西。\n我的網站是 michaello.me，GitHub 是 Michael0520。\n先說一下，我的英文沒有很流利，等下講解時如果哪裡卡卡的、或用詞怪怪的，請大家多多包容，也歡迎隨時打斷我、問我。\n\n———\n\n【English】\nQuick intro: I'm a web developer — I build websites for a living — and I'm also a member of Code for Taiwan, doing open-source community work.\nMy site is michaello.me, GitHub is Michael0520.\nAlso, a heads-up: my English isn't very fluent, so if I stumble or use an odd word along the way, please bear with me — and feel free to stop me and ask anytime.`,
  // AboutCode4tw
  `【中文】\n這裡花一分鐘介紹一下我的團隊 —— Code for Taiwan。\n它是一個公民科技社群，免費、開放，每個月有一次線上聚會，大家一起分享、一起學。\n不管你是工程師、設計師、PM、還是只是有興趣，背景完全不限，都歡迎來。\n我們的核心理念是「重觀念、不只重工具」—— 比起教你用某個工具，更想讓你懂背後的「為什麼」。\n今天這場 workshop 其實也是這個精神：你不用會寫程式，但你會帶走一套思考方式。\n官網是 codefortaiwan.org，有興趣回家可以看看。\n\n———\n\n【English】\nLet me take a minute to introduce my team — Code for Taiwan.\nIt's a civic-tech community: free, open, with a monthly online meetup where we share and learn together.\nWhether you're a developer, designer, PM, or just curious — every background is welcome.\nOur core idea is "concepts over tools" — rather than teaching you one specific tool, we want you to understand the why behind it.\nToday's workshop carries that same spirit: you don't need to code, but you'll walk away with a way of thinking.\nThe site is codefortaiwan.org — worth a look when you get home.`,
  `【中文】\n動手之前，先做兩個小調查，讓我抓一下大家的程度。\n第一個問題：過去 12 個月裡，有用 AI 寫過 code 的，請舉手。\n（停頓，掃一下，記個大概比例）好，放下。\n第二個：有真的用 AI 把一個網站 ship 上線過的，再舉一次手。\n（停頓，記比例）OK，大概知道大家的位置了 —— 沒舉手完全沒關係，今天就是從頭帶你做一次。\n\n———\n\n【English】\nBefore we start, two quick questions so I can read the room.\nFirst: in the last 12 months, who has written code with AI? Raise your hand.\n(pause, scan, note roughly) Okay, hands down.\nSecond: who has actually shipped a website live with AI? Raise again.\n(pause) Great — now I know where everyone is.\nIf you didn't raise your hand, no problem at all — today we'll walk through it from scratch.`,
  `【中文】\n我先給你今天最重要的一條分界線，這條線你聽懂了，今天就值回票價了 —— 用 AI 寫東西，其實有兩種模式（mode）。\n很多人沒意識到這件事，結果用得卡卡的。\n我們先把這兩種分清楚。\n\n———\n\n【English】\nLet me give you the single most important line of today — get this and the day is already worth it: building with AI actually comes in two modes.\nMost people don't realize this, and that's why it feels frustrating.\nLet's separate the two clearly.`,
  `【中文】\n第一種叫 Vibe Coding —— 你就是跟 AI 一直聊、它給你什麼你就收什麼、能跑起來就好。\n這種是「AI 主導」，你比較被動。\n第二種叫 AI Coding —— 你心裡有目標、會主動挑方案、看到不對會拒絕、關鍵時刻會跳進去改。\n這種是「你主導」。\n兩種沒有誰高誰低，但差別很大。\n\n———\n\n【English】\nThe first is Vibe Coding — you just keep chatting with the AI, take whatever it gives you, and you're happy if it runs.\nHere the AI leads and you're passive.\nThe second is AI Coding — you have a goal in mind, you actively pick approaches, you say no when something's off, and you step in at key moments.\nHere you lead.\nNeither is "better," but the difference is huge.`,
  `【中文】\n一句話總結：Vibe 是 AI 主導，AI Coding 是人主導。\n（這句慢慢講，停一下）說到底，AI 只是工具，真正的決策者是你。\n今天我想做的，就是把你從第一種，帶到第二種。\n\n———\n\n【English】\nIn one line: Vibe means the AI leads; AI Coding means you lead.\n(say this slowly, pause) At the end of the day, AI is just a tool — you are the decision-maker.\nWhat I want to do today is move you from the first mode to the second.`,
  `【中文】\n要強調：這兩種不是對立的，是看情況用。\n你做個玩具、週末隨手試個點子 —— 用 vibe 完全沒問題，輕鬆又快。\n但只要這東西你要長期維護、要上線給別人用、是個正式的專案 —— 就該切到 AI Coding。\n高手是兩種都會、知道什麼時候用哪一種。\n今天的目標就是帶你學會切換。\n\n———\n\n【English】\nTo be clear: these aren't rivals, you pick based on the situation.\nBuilding a toy, trying a quick weekend idea — vibe is totally fine, easy and fast.\nBut the moment it's something you'll maintain long-term, ship to real users, a serious project — switch to AI Coding.\nThe skilled move is knowing both and when to use which.\nToday's goal is to help you switch.`,
  // ScanQr
  `【中文】\n在開始裝東西之前，先請大家拿出手機，掃一下螢幕上這個 QR code —— 它會打開今天這份簡報。\n為什麼要掃？因為等一下安裝、還有後面動手的時候，會有幾行指令需要你複製，從手機上的簡報複製會比你自己一個字一個字打快很多、也不容易打錯。\n掃好、打開簡報的，舉個手讓我看看。\n\n———\n\n【English】\nBefore we install anything, please take out your phone and scan the QR code on screen — it opens these slides.\nWhy? Because during setup and the hands-on parts later, there are a few commands you'll need to copy, and copying from the slides on your phone is much faster and less error-prone than typing them out.\nRaise your hand once you've scanned it and the slides are open.`,
  `【中文】\n好，觀念先放這。動手之前，我們得先把工具裝好。\n今天要裝四樣東西：Warp（一個終端機）、Node 加 pnpm（跑網站的引擎）、Git（上傳用的）、還有 Claude Code（今天的主角）。\n聽起來有點多，但我會一步一步帶，每一步裝不起來就舉手，助教會立刻過去幫你。\n我們不趕，等大家都裝好再往下。\n\n———\n\n【English】\nOkay, concepts aside for now. Before we build, we need the tools installed.\nFour things today: Warp (a terminal), Node + pnpm (the engine that runs the site), Git (for uploading), and Claude Code (today's star).\nSounds like a lot, but I'll walk you through each one. If any step won't install, raise your hand and a helper comes right over.\nNo rush — we move on once everyone's set.`,
  `【中文】\n第一個，Warp。先解釋一下「終端機」是什麼 —— 就是那個可以打指令的黑色視窗，工程師每天都在用。\nWarp 是一個比較新、比較好用的終端機，介面好看、還內建 AI。\n我們一起到官網 warp.dev，點 Download，照著裝。（帶大家到官網實際操作，不要只是念）\n裝好、打得開的，舉個手讓我看看。\n\n———\n\n【English】\nFirst, Warp. Let me explain what a "terminal" is — it's that black window where you type commands; developers use it every day.\nWarp is a newer, nicer terminal — clean interface, AI built in.\nLet's go to warp.dev together, click Download, and install. (walk them to the actual site, don't just read it out)\nOnce it's installed and opens, raise your hand so I can see.`,
  `【中文】\n第二個，Node 和 pnpm —— 這是讓網站能在你電腦上跑起來的引擎。\n我們到 nodejs.org 的下載頁，選 macOS、nvm、pnpm 這幾個選項，官網會直接給你幾行指令。\n照著複製、貼到 Warp 裡：先裝 nvm，再 nvm install 24 裝 Node，最後 corepack enable pnpm。\nGit 大部分 Mac 已經內建，打 git --version 確認一下就好。（一樣帶大家到官網複製，不要自己手打）\n\n———\n\n【English】\nSecond, Node and pnpm — the engine that lets a website run on your computer.\nGo to the nodejs.org download page, pick macOS, nvm, pnpm, and the site hands you a few lines.\nCopy them into Warp: install nvm first, then nvm install 24 for Node, then corepack enable pnpm.\nGit is usually already on your Mac — just run git --version to check. (again, take them to the official site to copy, don't type it by hand)`,
  `【中文】\n第三個，Claude Code，今天的主角。它的官方文件在 code.claude.com，有繁體中文版。\n安裝超簡單，在 Warp 裡貼一行 curl 指令就好。\n裝完之後，在 Warp 打 claude 就能啟動它。等下我們整堂課都會用它。\n\n———\n\n【English】\nThird, Claude Code, today's star. The official docs are at code.claude.com, with a traditional-Chinese version.\nInstalling is dead simple — paste one curl line in Warp.\nOnce it's done, just type claude in Warp to launch it. We'll use it for the rest of the workshop.`,
  `【中文】\n來，一起檢查裝好了沒。在 Warp 裡一個一個打：node -v、pnpm -v、git --version、claude --version。\n每一個都應該跳出一個版本號碼 —— 只要看到版本號，就代表那個工具裝好了。\n四個都看到版本的，舉手讓我確認一下。\n（這頁多留一點時間，這是第一個關卡，沒過的個別去救援，確保大家都過了再往下）\n\n———\n\n【English】\nLet's check everything together. In Warp, type these one by one: node -v, pnpm -v, git --version, claude --version.\nEach should print a version number — if you see a version, that tool is installed.\nRaise your hand if you see all four.\n(give this slide extra time — it's the first checkpoint; help anyone stuck individually and make sure everyone passes before moving on)`,
  `【中文】\n工具到位了。第一段我們把環境跟觀念都準備好了。\n接下來第二段，我們學怎麼真正「驅動」Claude Code，還有一個讓 AI 從「能用」變成「可靠」的關鍵習慣，叫 SDD。\n\n———\n\n【English】\nTools are ready. In hour one we got the environment and the concepts set.\nNext, in hour two, we learn to actually "drive" Claude Code, plus the one habit that turns AI from "usable" into "reliable": SDD.`,
  // H2
  `【中文】\n歡迎回來。\n工具大家都裝好了，現在進到重點：怎麼「驅動」它 —— 也就是怎麼讓 Claude Code 真的照你的意思做事，而不是亂做一通。\n\n———\n\n【English】\nWelcome back.\nEveryone's got the tools installed — now the key part: how to "drive" it.\nThat is, how to get Claude Code to actually do what you mean, instead of going off on its own.`,
  `【中文】\n打開 Claude Code 真的很簡單：在 Warp 裡打一個字 claude，按 enter，它就啟動了。\n然後你就用平常講話的方式，跟它說你要什麼就好 —— 不用背任何指令、不用記語法。\n這就是它對新手最友善的地方。\n\n———\n\n【English】\nOpening Claude Code is genuinely easy: in Warp, type the word claude, press enter, and it starts.\nThen you just talk to it in plain language and tell it what you want — no commands to memorize, no syntax to learn.\nThat's what makes it so beginner-friendly.`,
  `【中文】\n這裡我要特別講一個習慣，它是 vibe coding 跟 AI coding 的分水嶺 —— Plan Mode。\n在 Claude Code 裡連按兩次 Shift+Tab，它就不會馬上動手，而是先給你一份計畫：它打算做什麼、要改哪些檔案、按什麼順序。\n你看過、覺得 OK、按核可，它才開始做。\n核心一句話：動手前先給計畫，不要邊做邊發明。\n（這句停一下，讓它沉下去）這就是你拿回主導權的關鍵 —— AI 想偏了，你在計畫階段就攔下來，不用等它做完一團才後悔。\n\n———\n\n【English】\nLet me highlight one habit — it's the dividing line between vibe coding and AI coding: Plan Mode.\nIn Claude Code, press Shift+Tab twice and it won't act right away — instead it gives you a plan: what it intends to do, which files it'll change, in what order.\nYou review it, approve it, and only then does it run.\nThe core line: plan before acting, don't improvise as you go.\n(pause, let it land) This is how you take back control — if the AI drifts, you catch it at the plan stage, instead of regretting a big mess after it's done.`,
  `【中文】\n為什麼要這麼麻煩？因為如果你只是用嘴巴一直聊，通常會踩三個坑。\n第一，風格不一致 —— 你今天講的跟明天講的不一樣，做出來就不一樣。\n第二，漏掉狀況 —— AI 只做了正常情況，沒網路、欄位空白這些它沒想到。\n第三，最危險的，假性自信 —— AI 會很開心地跟你說「做完了！」但你要問：做完什麼？\n\n———\n\n【English】\nWhy bother? Because if you just keep chatting, you usually hit three traps.\nOne, inconsistency — what you say today differs from tomorrow, so the output differs.\nTwo, missed cases — the AI only handles the happy path; no offline, no empty fields.\nThree, the most dangerous, false confidence — the AI cheerfully says "Done!" — but you have to ask: done with what?`,
  `【中文】\n我把今天最重要的一句話送給你：當 AI 說「做完了」，你要反問一句 —— 做完什麼？（停一下）如果你答不出來，那不是 AI 的問題，是你從一開始就沒定義「什麼叫做完」。\nSDD 要解的就是這件事 —— 在動手之前，先把「做完」的標準寫下來。\n\n———\n\n【English】\nHere's the most important line of the day: when the AI says "Done," ask it back — done with what? (pause) If you can't answer, that's not the AI's fault — it's that you never defined "done" in the first place.\nThat's exactly what SDD solves: before you start, write down what "done" means.`,
  `【中文】\n怎麼把要什麼寫清楚？三個階段，而且用人話寫就好，不用很工程。\n第一，釐清你要什麼 —— 給誰看、為了什麼，這定方向。\n第二，怎麼做 —— 用什麼版型、放哪些區塊、有什麼限制，這定範圍。\n第三，拆成一條條可以勾選的任務 —— 每條都能說「做到了沒」。\n整個循環一句話：寫清楚 → AI 做 → 拿它來驗 → ship。\n\n———\n\n【English】\nHow do you write down what you want? Three stages, and just use plain words — nothing technical.\nOne, clarify what you want — for whom, and why; this sets the direction.\nTwo, how to do it — what layout, which sections, what limits; this sets the scope.\nThree, break it into checkable tasks — each can be marked done or not.\nThe whole loop in one line: write it clearly → AI builds → check it → ship.`,
  `【中文】\n來試一下手感，讓你感覺一下。\n打開 Claude Code，跟它說：「幫我在桌面建一個資料夾叫 my-first，裡面放一個寫著我名字的文字檔。」然後看 —— 它會先給你計畫，你按核可，它才動手做。\n這個「計畫 → 核可 → 執行」的節奏，就是 AI Coding 的手感。\n（走動，看看大家的反應，鼓勵一下）\n\n———\n\n【English】\nLet's get a feel for it.\nOpen Claude Code and say: "Create a folder on my Desktop called my-first with a text file that has my name in it." Then watch — it gives a plan first, you approve, and only then it acts.\nThat rhythm — plan, approve, execute — is the feel of AI Coding.\n(walk around, watch reactions, encourage them)`,
  `【中文】\n你已經會用了。\n第三段，我們把這整套用在一個真的網站上：clone 一個現成的範本、用 Claude Code 改成你的、然後推上線。\n我保證，離開這個房間前，每個人都會有自己的網址。\n現在休息 10 分鐘，16:00 準時回來。\n\n———\n\n【English】\nYou can use it now.\nIn hour three, we apply all of this to a real website: clone a ready-made template, make it yours with Claude Code, then ship it.\nI promise — before you leave this room, everyone will have their own URL.\nTake a 10-minute break, back at 16:00 sharp.`,
  // H3
  `【中文】\n歡迎回來，最後一小時了，這一小時幾乎全程動手。\n我們會抓一個現成的網站範本，用 Claude Code 把它改成你的，然後推上線。\n再強調一次：離開前，每個人都會有自己的網址，這是今天的承諾。\n\n———\n\n【English】\nWelcome back — last hour, and it's almost all hands-on.\nWe'll grab a ready-made website template, make it yours with Claude Code, then ship it.\nOnce more: before you leave, everyone will have their own URL.\nThat's the promise.`,
  `【中文】\n動手之前，先花一分鐘看一份 spec —— 這是我提前幫你寫好的個人站 spec。\n它有五個區塊：Goal 是這個網站的目的、Outcomes 是訪客看完帶走什麼、Non-goals 是明說不做的事、Constraints 是限制、Success criteria 是怎麼算成功。\n等一下你就會照著這份去改。\n看起來不嚇人吧？就是用人話講清楚要什麼。\n\n———\n\n【English】\nBefore we build, take a minute to read a spec — this is one I wrote ahead of time for the personal site.\nIt has five blocks: Goal is the site's purpose, Outcomes is what a visitor takes away, Non-goals is what you explicitly won't do, Constraints are the limits, and Success criteria is how you know it worked.\nYou'll edit based on this in a moment.\nNot scary, right? It's just plainly stating what you want.`,
  `【中文】\n為什麼一定要這五塊？因為少了任何一塊，AI 就會自由發揮。\n沒有 Goal，它就做一個很普通的 portfolio；沒有 Non-goals，它會加一堆你根本沒要的功能；沒有 Success criteria，你自己也不知道到底做好了沒。\n所以這五塊，其實就是你給 AI 的一份「契約」。\n\n———\n\n【English】\nWhy these five blocks? Because miss any one and the AI improvises.\nNo Goal, it builds a generic portfolio; no Non-goals, it adds features you never asked for; no Success criteria, you don't even know if it's done.\nSo these five blocks are really a "contract" you give the AI.`,
  `【中文】\n第一步，clone。\n在 Warp 裡打 git clone 加上範本的網址，再 cd 進那個資料夾。\nclone 的意思就是把網路上的範本，整包複製到你自己的電腦。\n網址我會貼在大白板上，照著打就好。\n卡住的舉手。\n（走動巡視，看看大家有沒有打錯字）\n\n———\n\n【English】\nStep one, clone.\nIn Warp, type git clone plus the template's URL, then cd into that folder.\nClone just means copying the whole template from the web onto your own computer.\nI'll put the URL on the big board — just type it as shown.\nRaise your hand if stuck.\n(walk around, check for typos)`,
  `【中文】\n第二步，跑起來。\n打 pnpm install 把需要的套件裝好，再打 pnpm dev 把它跑起來。\n看到 Ready，就打開瀏覽器、輸入 localhost:3000，你應該會看到一個現成的範本網站。\n看到的舉手。\n（這頁多留時間，這是第一個動手關卡，沒看到的我個別過去看）\n\n———\n\n【English】\nStep two, run it.\nType pnpm install to install the packages, then pnpm dev to start it.\nWhen you see Ready, open your browser at localhost:3000 — you should see a ready-made template site.\nRaise your hand when you see it.\n(give this extra time — first hands-on checkpoint; I'll come help anyone who doesn't see it)`,
  `【中文】\n現在最有趣的部分：用 Claude Code 把它改成你的。\n先確認你是在 portfolio-workshop 這個資料夾裡打開 claude，然後照著念：「幫我把這個網站的名字改成你的名字、城市改成你住的城市、自我介紹改成一句話。」它會先給計畫、你核可、它就改好了。\n改完重新整理網頁、看到自己資料的，舉手。\n（走動，這關有人會卡，個別救援）\n\n———\n\n【English】\nNow the fun part: make it yours with Claude Code.\nFirst make sure you opened claude inside the portfolio-workshop folder, then say: "Change this site's name to your name, the city to where you live, and the intro to one line about you." It plans, you approve, it edits.\nRefresh the page and raise your hand when you see your own info.\n(walk around — some will get stuck here, help individually)`,
  `【中文】\n資料是你的了，現在把它放上 GitHub。\n到 github.com/new，名字隨便取，記得選 Public、然後不要勾任何初始化選項，按 Create。\n這幾個設定很重要，尤其「不要勾初始化」，不然等下推的時候會衝突。\n\n———\n\n【English】\nYour info is in.\nNow put it on GitHub.\nGo to github.com/new, name it anything, choose Public, and don't check any init options, then hit Create.\nThese settings matter — especially "don't check init," otherwise the push will conflict later.`,
  `【中文】\nCreate 完，GitHub 會直接給你兩行指令，你把它複製、貼到 Warp 裡跑就好。\n如果你不想自己打，也可以直接請 Claude Code 幫你推上去 —— 跟它說「幫我把這個專案推到 GitHub」就行。\n卡住的舉手。\n\n———\n\n【English】\nAfter Create, GitHub hands you two lines — copy them and run them in Warp.\nIf you'd rather not type, just ask Claude Code to push for you — say "push this project to GitHub." Raise your hand if stuck.`,
  `【中文】\n最後一步，上線。\n到 vercel.com，點 New Project，Import 你剛剛建的那個 repo，全部用預設、按 Deploy。\n大概 30 秒，它就會給你一個網址。\nDeploy 成功、拿到網址的，舉手讓我看看。\n\n———\n\n【English】\nLast step, go live.\nGo to vercel.com, click New Project, Import the repo you just made, keep all defaults, hit Deploy.\nIn about 30 seconds it gives you a URL.\nRaise your hand when your deploy succeeds and you have a URL.`,
  `【中文】\n現在，你有自己的網址了！這是今天的高潮。\n兩件事：第一，把網址貼到共享白板上，大家互相看看彼此做的；第二，截個圖、分享出去，這是你今天的紀念。\n這個感覺 —— 就是 ship。\n（這裡能量拉高，幫大家鼓掌一下）\n\n———\n\n【English】\nNow — you have your own URL! This is the high point of the day.\nTwo things: one, post your URL on the shared board so everyone can see each other's work; two, take a screenshot and share it — that's your souvenir for today.\nThis feeling — this is shipping.\n(raise the energy here, get a round of applause)`,
  `【中文】\n網站雖然上線了，但它還是「範本的樣子」，不夠像你。\n想讓它更專業，與其自己慢慢調 CSS，不如裝一個專門做設計的 skill。\nClaude Code 也能裝 skill，指令就是 npx skills add。\nskills.sh 是 Vercel 做的開放目錄，你可以去逛逛，排行榜第一名 find-skills 有一百五十萬次安裝，很多好東西。\n\n———\n\n【English】\nYour site is live, but it still looks like the template — not quite you yet.\nTo make it more polished, instead of tweaking CSS by hand, install a design skill.\nClaude Code can add skills too — the command is npx skills add. skills.sh is an open directory by Vercel; go browse it.\nThe top one, find-skills, has 1.5 million installs — lots of good stuff there.`,
  `【中文】\n我帶你裝一個我自己很愛、而且免費的設計 skill —— Impeccable，它的作用就是「教你的 AI 設計品味」。\n在 Warp 裡打 npx skills add pbakaus/impeccable。\n裝完之後，你就多了 23 個設計指令、7 個參考領域、還有 27 條反模式偵測規則。\n它是從 Anthropic 官方的 frontend-design skill 演化來的。\n\n———\n\n【English】\nLet me have you install a design skill I love, and it's free — Impeccable.\nIts whole job is to "teach your AI design taste." In Warp, type npx skills add pbakaus/impeccable.\nOnce installed, you gain 23 design commands, 7 reference domains, and 27 anti-pattern rules.\nIt evolved from Anthropic's official frontend-design skill.`,
  `【中文】\n裝好就用用看。\n跟 Claude Code 說「用 /polish 幫我的個人站打磨設計」。\n為什麼需要它？因為 AI 看過太多類似的範本，如果你沒特別講，它就會生出那種「一看就知道是 AI 做的」設計 —— Inter 字體、紫藍漸層、卡片疊卡片。\nImpeccable 做的事，就是把「好設計」變成 AI 跟你之間共用的詞彙，讓它知道你要的是什麼。\n\n———\n\n【English】\nNow use it.\nTell Claude Code "use /polish to refine my personal site's design." Why do you need it? Because the AI has seen too many similar templates — if you don't say otherwise, it produces that unmistakable "made by AI" look: Inter font, purple-blue gradients, cards stacked on cards.\nWhat Impeccable does is turn "good design" into shared vocabulary between you and the AI, so it knows what you actually want.`,
  `【中文】\n三小時走到這了，我們回顧一下你今天帶走了什麼。\n第一小時，你把工具都裝好了，也懂了 Vibe 跟 AI Coding 的差別。\n第二小時，你會用 Claude Code 了，也學會用 SDD 把「要什麼」講清楚。\n第三小時，你從一個範本，一路做到一個 live URL，真的 ship 了自己的網站。\n回家之後，就用今天這套工作方式，把你下一個想法也 ship 出來。\n\n———\n\n【English】\nThree hours in — let's recap what you're taking home.\nHour one, you installed all the tools and got the difference between Vibe and AI Coding.\nHour two, you can drive Claude Code and learned to spell out what you want with SDD.\nHour three, you went from a template all the way to a live URL — you actually shipped your own site.\nBack home, use this same workflow to ship your next idea too.`,
  `【中文】\n謝謝大家今天的耐心，三個小時對講者跟學員都不短。\n兩件事帶走：一個是你今天親手 ship 的網址，另一個是一整套用 AI 把東西做出來的工作方式。\n有任何問題、卡關、想多聊的，都來找我，我會留到 17:30，michaello.me 跟 GitHub 都歡迎。\n\n———\n\n【English】\nThank you all for your patience — three hours is long for everyone.\nTwo things to take home: the URL you shipped today, and a whole way of building things with AI.\nAny questions, anything you're stuck on, anything you want to chat about — come find me, I'll be here until 17:30, michaello.me and GitHub both welcome.`,
];
